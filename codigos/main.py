...
if __name__ == "__main__":
    ...
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/eil51-experiment.json"
    # )
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/berlin52_1-experiment.json"
    # )
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/berlin52_2-experiment.json"
    # )
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/eil76_1-experiment.json"
    # )
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/eil76_2-experiment.json"
    # )
    # analysis = solver.analyze_centroid_experiment(
    #     "solucoes/experiments/rat99-experiment.json"
    # )
